...
import insta from "../Assets/1200px-Instagram_logo.svg.png"
  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="fixed" sx={{background:"white"}}>
        <Toolbar>
          <div className="">
              <img style={{height:"8vh",width:"9rem",marginLeft:"4rem"}} src={insta} onClick={handelBannerClick}></img>
          </div>
          <Box sx={{ flexGrow: 1 }} />
          <Box sx={{ display: { xs: 'none', md: 'flex' }, color:"black",alignItems:"center",marginRight:"4rem" }}>
            ...
            <IconButton
              ...
              color="inherit"
            >
              <Avatar  sx={{height:"2rem", width:"2rem"}}></Avatar>
            </IconButton>
          </Box>
